...
MAIN=main
SOURCES=$(MAIN).tex Makefile tex/abstract.tex tex/introduction.tex tex/background/*.tex tex/result.tex preamble.tex tex/title.tex bibliography/references.bib
