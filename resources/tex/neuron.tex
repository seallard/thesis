...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!50, node distance=\layersep]
    ...
    \draw[->] (activation)--(output1) node[pos=.6,above]{};
    \draw[->] (activation)--(output2) node[pos=.6,below]{};
    \draw[->] (input1)--(summation) node[pos=.4,above]{$w_{1}$};
    \draw[->] (input2)--(summation) node[pos=.4,above]{$w_{2}$};
    \draw[->] (input3)--(summation) node[pos=.4,above]{$w_{3}$};
