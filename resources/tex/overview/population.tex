...
\begin{tikzpicture}
  ...
  \node (line1) [anchor=south west] at (population.south west) {$\coloredrule{10mm}{1mm}{green!75}$};
  ...
  \node (line5) [anchor=south west] at (line2.north west) {$\coloredrule{10mm}{1mm}{green!50}$};
  ...
  \node (line9) [anchor=south west] at (line6.north west) {$\coloredrule{10mm}{1mm}{green!25}$};
