...
In NDWS, a weighted sum of novelty and fitness is used. The weights are updated during runtime such that the novelty
...
of fitness and novelty which has been shown to perform well at the maze task \cite{ns_study}.
