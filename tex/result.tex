...
None of the variants were able to solve the hard maze within the $400$ given time steps.
...
However, some of the variants found controllers which navigated through large parts of the
maze. If the experiments had been run with a slightly larger number
The fitness based search quickly converges on controllers which stack up in the first
dead-end and never escapes it.